...
public class mainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MainAcademy");
        setResizable(false);

        jDesktop.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jDesktop.setMaximumSize(new java.awt.Dimension(600, 600));
        jDesktop.setMinimumSize(new java.awt.Dimension(600, 600));
